...
const CREDENTIALS = {
   ...
   admin: { email: 'admin@chemist.com', password: 'Chemist!2025@admin' },
  cashier: { email: 'cashier@chemist.com', password: 'cashier!2025@chemistt' },
};
...
const [showPassword, setShowPassword] = useState(false);
  ...
  <button
    ...
    className="absolute right-3 top-9 text-sm text-muted-foreground hover:text-primary"
  >
